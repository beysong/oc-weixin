...
use Beysong\Weixin\Models\Adlet as BlogPost;
use Beysong\Weixin\Models\Tag as BlogCategory;

class Adlets extends ComponentBase
{
    /**
    ...
    protected function listPosts()
    {
        ...
        $posts = BlogPost::with('tags')->listFrontEnd([
        ...
        //     if($post->imgs){
        //         $posts[$key]['imgs2'] = $post->imgs->getPath();
        //     }
        // }
        return $posts;
    }
